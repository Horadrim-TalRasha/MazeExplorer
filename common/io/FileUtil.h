...
public:
	...
	static int GetDiskSz7OldTm(char *szpDatPath, unsigned long long &u64CurSize, time_t &tMin, char *szpOldFile); //获取访问时间最老的
	static int RefreshFile(char *szpFileName, unsigned long long &u64AccessTime); //修改访问时间
